...
data_transforms = {
    'train': transforms.Compose([
        ...
        transforms.RandomCrop(128, padding_mode='symmetric'),
...
weight = np.array([3.0,  1.0, 2.0, 1.0,  1.0, 2.0,   1.0,  1.0,  2.0,  2.0,  1.0])

sampler = WeightedRandomSampler([weight[label] for data, label in train_set], len(train_set), replacement=True)
